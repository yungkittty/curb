...
const isFetching = (state = false, action) => {
  switch (action.type) {
    ...
    case mediasActionsTypes.POST_MEDIAS_TEXT_CONTENT_SUCCESS:
    case mediasActionsTypes.POST_MEDIAS_TEXT_CONTENT_FAILURE:
      return false;
    default:
      return state;
  }
...
const errorCode = (state = "", action) => {
  switch (action.type) {
    ...
    case mediasActionsTypes.POST_MEDIA_AVATAR_GROUP_REQUEST:
    case mediasActionsTypes.POST_MEDIA_AVATAR_GROUP_SUCCESS:
    case mediasActionsTypes.POST_MEDIAS_TEXT_CONTENT_REQUEST:
    case mediasActionsTypes.POST_MEDIAS_TEXT_CONTENT_SUCCESS:
      return "";
    case mediasActionsTypes.GET_MEDIA_FAILURE:
    case mediasActionsTypes.POST_MEDIA_AVATAR_USER_FAILURE:
