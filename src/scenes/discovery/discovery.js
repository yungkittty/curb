  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        <Card
          style={{ marginTop: platformBools.isWeb ? 60 : 50 }}
          userId="5d89f888d93e22001db00053"
          cardMenu={[
            { text: t("common:delete"), icon: "trash", onClick: () => console.log("pin") },
            { text: t("common:report"), icon: "flag", onClick: () => console.log("pin") }
          ]}
          mediaDateCreation="2019-09-27T13:38:01.240Z"
          onFloatingButtonClick={() => console.log("toto")}
          likeNumber="3 K"
          floatingButtonColor="rgb(86, 204, 242)"
          mediaList={{
            text:
              "Nous partageons sur ce post des plans ride localisés par la communauté pouvez également y partager vos photos et vidéos de vos tricks et suivre ceux des autres. Nous partageons sur ce post des plans ride localisés par la communauté sur toute la France. Vous pouvez également y partager vos photos et vidéos de vos tricks et suivre ceux des autres. Nous partageons sur ce post des plans ride localisés par la communauté sur toute la France. Vous pouvez également y partager vos photos et vidéos de vos tricks et suivre ceux des autres. Nous partageons sur ce post des plans ride localisés par la communauté sur toute la France. Vous pouvez également y partager vos photos et vidéos de vos tricks et suivre ceux des autres par exemple",
            image: (
              <ImageGallery
                imagesData={[
        ...
        <Card
          ...
          mediaList={{
            text:
              "Nous partageons sur ce post des plans ride localisés par la communauté sur toute la France. Vous pouvez également y partager vos photos et vidéos de vos tricks et suivre ceux des autres. Nous partageons sur ce post des plans ride localisés par la communauté sur toute la France. Vous pouvez également y partager vos photos et vidéos de vos tricks et suivre ceux des autres. Nous partageons sur ce post des plans ride localisés par la communauté sur toute la France. Vous pouvez également y partager vos photos et vidéos de vos tricks et suivre ceux des autres. Nous partageons sur ce post des plans ride localisés par la communauté sur toute la France. Vous pouvez également partager vos photos et vidéos de vos tricks, ou suivre ceux des autres par exemple."
          }}
        />
        <Card
          style={{ marginTop: platformBools.isWeb ? 60 : 50 }}
        ...
        <Card
          ...
          mediaDateCreation="2019-09-27T13:38:01.240Z"
        />
        <Card style={{ marginTop: platformBools.isWeb ? 60 : 50 }} groupId="5dac9a1e501e2a001de8e19f" />
        <Card
          style={
            platformBools.isWeb ? { marginTop: 60, marginBottom: 40 } : { marginTop: 50, marginBottom: 30 }
          }
