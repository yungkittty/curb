...
const InputImage = ({ t, onSelect, ...others }) => (
  <Button
    {...others}
    onClick={() => {
...
InputImage.propTypes = { t: PropTypes.func.isRequired, onSelect: PropTypes.func.isRequired };

export default withTranslation("common")(InputImage);
