...
const InputVideo = ({ t, onSelect, ...others }) => (
  <Button
    {...others}
    onClick={() => {
...
InputVideo.propTypes = { t: PropTypes.func.isRequired, onSelect: PropTypes.func.isRequired };

export default withTranslation("common")(InputVideo);
