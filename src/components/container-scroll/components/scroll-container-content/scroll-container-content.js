...
const ScrollContainerContent = styled(Container)`
  ...
  width: calc(
    100% ${props => (props.showsHorizontalScrollIndicator ? " + 30px" : "")}
  );
  height: calc(
    100% ${props => (props.showsVerticalScrollIndicator ? " + 30px" : "")}
  );
  ${props =>
    props.showsHorizontalScrollIndicator ? "padding-right: 30px" : ""};
  ${props =>
    props.showsVerticalScrollIndicator ? "padding-bottom: 30px" : ""};
  overflow: auto;
`;
