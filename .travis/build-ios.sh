...
openssl aes-256-cbc -k "$ENCRYPT_PASSWORD" -in curb-development-key.certificate.p12.enc -d -a -out curb-development-key.certificate.p12
...
security import curb-development-key.certificate.p12 -k ios-build.keychain -P "$DEV_KEY_PASSWORD" -A
